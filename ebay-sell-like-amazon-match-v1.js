...
function render(list){
  ...
  lastMatches.forEach((x,i)=>{
    ...
    const info='<div style="min-width:0;line-height:1.15;padding-right:66px">'+
      ...
      '<div style="margin-top:3px;color:#666;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+esc(x.asin||'')+'</div>'+
      '</div>';
