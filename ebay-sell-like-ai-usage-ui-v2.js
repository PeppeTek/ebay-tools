javascript:(()=>{
'use strict';
const PATCH_ID='capitan-ai-usage-ui-v4';
const MODAL_ID='capitan-pricing-modal';
const ENDPOINT_KEY='pep-ebay-bs-v6-google-url';
document.getElementById('capitan-ai-usage-ui-v2')?.remove();document.getElementById('capitan-ai-usage-ui-v3')?.remove();if(document.getElementById(PATCH_ID))return;
...
function patch(){
  ...
  delete modal.dataset.aiUsageV2;delete modal.dataset.aiUsageV3;modal.dataset.aiUsageV4='1';
  ...
  const aiBody=document.createElement('div');aiBody.id='capitan-ai-usage-body';aiBody.style.cssText='display:none;padding:18px 22px 22px;min-height:0;overflow:hidden;flex:1;flex-direction:column';rateBody.insertAdjacentElement('afterend',aiBody);
