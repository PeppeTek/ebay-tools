...
function patch(){
  ...
  rateTab.addEventListener('click',()=>{rateBody.style.display='block';aiBody.style.display='none';rateTab.style.borderBottomColor='#1668e8';rateTab.style.color='#1668e8';aiTab.style.borderBottomColor='transparent';aiTab.style.color='#555'});
  aiTab.addEventListener('click',()=>{rateBody.style.display='none';aiBody.style.display='block';rateTab.style.borderBottomColor='transparent';rateTab.style.color='#555';aiTab.style.borderBottomColor='#1668e8';aiTab.style.color='#1668e8';render(aiBody)});
}
